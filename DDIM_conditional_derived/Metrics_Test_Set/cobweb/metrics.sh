#!/bin/bash
#SBATCH --job-name=RMSE_Metrics_Test_Set
#SBATCH --output=DDIM_conditional_derived/logs/Metrics_Test_Set/rmse_test_set_job_%j.log
#SBATCH --error=DDIM_conditional_derived/logs/Metrics_Test_Set/rmse_test_set_job_%j.log
#SBATCH --ntasks=1
