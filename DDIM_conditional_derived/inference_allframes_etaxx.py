...
num_samples = 11 #Deterministic sample : single run,,,,,
...
ds_ddim.to_netcdf("DDIM_conditional_derived/output_inference/ddim_downscaled_30steps_test_set_11samples_2011_2023.nc", encoding=encoding)
