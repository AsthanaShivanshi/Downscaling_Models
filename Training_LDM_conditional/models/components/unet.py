...
class DownscalingUnet(nn.Module):
    def __init__(self, in_ch=1, out_ch=1, features=[64,128,256,512],context_ch=0):
        super().__init__()

        self.context_ch=context_ch
        total_in_ch= in_ch + context_ch
        self.e1 = EncoderBlock(total_in_ch, features[0]) #input channels changed due to requirement for conditioning : AsthanaSh
    ...
    def forward(self, x, context=None):
        ...
        #concatenating context if provided/available : AsthanaSh
        ...
        #padding to make it multiple of 16 for feeding into UNet : AsthanaSh
