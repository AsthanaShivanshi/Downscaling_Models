...
def main():
    ...
    model_path = f"{config.MODELS_DIR}/tmin_MPI-CSC-REMO2009_MPI-M-MPI-ESM-LR_rcp85_1971-2099/tmin_r01_coarse_masked.nc"
    obs_path = f"{config.DATASETS_TRAINING_DIR}/TminD_step2_coarse.nc"
    output_path = f"{config.BIAS_CORRECTED_DIR}/EQM/tmin_QM_BC_MPI-CSC-REMO2009_MPI-M-MPI-ESM-LR_rcp85_1971-2099_r01.nc"
