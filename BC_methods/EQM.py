...
print("Data")
model_output = xr.open_dataset(model_path,chunks={"time":500})["tmax"]
obs_output = xr.open_dataset(obs_path,chunks={"time":500})["TmaxD"]
...
encoding= {"tmax": {"zlib": True, "complevel": 4}} #For accelerated writing
