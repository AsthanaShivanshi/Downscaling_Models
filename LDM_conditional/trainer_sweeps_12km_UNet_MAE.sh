#!/bin/bash
#SBATCH --job-name=YJ_MAE_12km_UNet_MAE_Sweep
#SBATCH --output=logs/ckpts_LDM/UNet/YJ_UNetMAESweep_job_output-%j.txt
#SBATCH --error=logs/ckpts_LDM/UNet/YJ_UNetMAESweep_job_error-%j.txt
#SBATCH --ntasks=1
