...
unet_state_dict = torch.load(paths.LDM_DIR+"/trained_ckpts_optimised/12km/LDM_conditional.models.unet_module.DownscalingUnetLightning_bs32_lr0.01_delta1.0_crps[0, 1]_factor0.5_pat3.ckpt.ckpt", map_location="cpu",
