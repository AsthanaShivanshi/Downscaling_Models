...
train_input_paths = {
    'precip': paths.DATASETS_TRAINING_DIR+"/RhiresD_input_train_scaled_yeojohnson.nc",
    'temp': paths.DATASETS_TRAINING_DIR+"/TabsD_input_train_scaled.nc",
    
}
train_target_paths = {
    'precip': paths.DATASETS_TRAINING_DIR+"/RhiresD_target_train_scaled_yeojohnson.nc",
    'temp': paths.DATASETS_TRAINING_DIR+"/TabsD_target_train_scaled.nc",
    
}
val_input_paths = {
    'precip': paths.DATASETS_TRAINING_DIR+"/RhiresD_input_val_scaled_yeojohnson.nc",
    'temp': paths.DATASETS_TRAINING_DIR+"/TabsD_input_val_scaled.nc",
    
}
val_target_paths = {
    'precip': paths.DATASETS_TRAINING_DIR+"/RhiresD_target_val_scaled_yeojohnson.nc",
    'temp': paths.DATASETS_TRAINING_DIR+"/TabsD_target_val_scaled.nc",
    
}
test_input_paths = {
    'precip': paths.DATASETS_TRAINING_DIR+"/RhiresD_input_test_scaled_yeojohnson.nc",
    'temp': paths.DATASETS_TRAINING_DIR+"/TabsD_input_test_scaled.nc",
    
}
test_target_paths = {
    'precip': paths.DATASETS_TRAINING_DIR+"/RhiresD_target_test_scaled_yeojohnson.nc",
...
with open(paths.DATASETS_TRAINING_DIR+"/RhiresD_scaling_params_yeojohnson.json", 'r') as f:
...
unet_state_dict = torch.load(paths.LDM_DIR+"/trained_ckpts_optimised/12km/LDM_conditional.models.unet_module.DownscalingUnetLightning_bs32_lr0.001_delta1.0_crps[0, 1]_factor0.5_pat3.ckpt.ckpt", map_location="cpu",
