...
plt.title('(colored by kl_weight): Val Set MAE vs Latent Dimension of the VAE Bottleneck', fontsize=19)
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("outputs/vae_latentdim_vs_valloss_by_klweight.png", dpi=1000)
plt.show()
