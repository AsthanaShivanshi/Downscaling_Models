...
with open("Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_scaling_params.json", "r") as f:
    pr_params = json.load(f)
with open("Dataset_Setup_I_Chronological_12km/TabsD_bicubic_scaling_params.json", "r") as f:
    temp_params = json.load(f)

train_input_paths = {
    "precip": "Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_input_train_scaled.nc",
    "temp": "Dataset_Setup_I_Chronological_12km/TabsD_bicubic_input_train_scaled.nc",
}
train_target_paths = {
    "precip": "Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_target_train_scaled.nc",
    "temp": "Dataset_Setup_I_Chronological_12km/TabsD_bicubic_target_train_scaled.nc",
}
val_input_paths = {
    "precip": "Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_input_val_scaled.nc",
    "temp": "Dataset_Setup_I_Chronological_12km/TabsD_bicubic_input_val_scaled.nc",
}
val_target_paths = {
    "precip": "Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_target_val_scaled.nc",
    "temp": "Dataset_Setup_I_Chronological_12km/TabsD_bicubic_target_val_scaled.nc",
}
test_input_paths = {
    "precip": "Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_input_test_scaled.nc",
    "temp": "Dataset_Setup_I_Chronological_12km/TabsD_bicubic_input_test_scaled.nc",
}
test_target_paths = {
    "precip": "Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_target_test_scaled.nc",
    "temp": "Dataset_Setup_I_Chronological_12km/TabsD_bicubic_target_test_scaled.nc",
}
...
unet_regr = DownscalingUnetLightning(
    ...
    precip_scaling_json="Dataset_Setup_I_Chronological_12km/RhiresD_bicubic_scaling_params.json",
)


unet_regr_ckpt = torch.load(
    "LDM_conditional/trained_ckpts/12km/BICUBIC_LDM_conditional.models.unet_module.DownscalingUnetLightning_bs32_lr0.001_delta1.0_factor0.5_pat3.ckpt",
    map_location="cpu",
    weights_only=False,
...
out_path = os.path.join(output_dir, "BICUBIC_unet_downscaled_val_set.nc")
